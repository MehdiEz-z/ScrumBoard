	...
	<div id="app" class="app app-header-fixed app-sidebar-fixed">
			...
			<div class="navbar-nav">
				...
				<div class="navbar-item navbar-user dropdown">
					<a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
						...
						<span>
							<span class="d-none d-md-inline">Mehdi EZZAHRI</span>
							<b class="caret"></b>
						</span>
					</a>
		...
		<div id="content" class="app-content" style="min-height: 100vh; background: url(assets/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
			<div class="d-flex align-items-center mb-3">
				...
				<div class="ms-auto">
				<a href="#modal-task" data-bs-toggle="modal" id="addTask" class="btn btn-success btn-rounded px-4 rounded-pill"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i> Add Task</a>
				</div>
			</div>
				...
				<form action="scripts.php" method="POST" id="form-task">
					...
					<div class="modal-body">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="task-title" value="" id="task-title" required/>
							</div>
							<div class="mb-3">
								<label class="form-label">Type</label>
								<div class="ms-3">
									<div class="form-check mb-1">
										<input class="form-check-input" name="task-type" type="radio" value="2" id="Feature"/>
										<label class="form-check-label" for="task-type-feature">Feature</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" name="task-type" type="radio" value="1" id="Bug"/>
							...
							<div class="mb-3">
								...
								<input type="datetime-local" class="form-control" name="task-date" id="task-date" required/>
							</div>
							<div class="mb-0">
								<label class="form-label">Description</label>
								<textarea class="form-control" name="task-description" rows="8" id="task-description" required></textarea>
							</div>
